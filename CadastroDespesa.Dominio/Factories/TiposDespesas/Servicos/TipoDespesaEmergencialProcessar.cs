...
namespace CadastroDespesa.Dominio.Factories.TiposDespesas.Servicos
{
    public class TipoDespesaEmergencialProcessar : ITipoDespesaEmergencialProcessar
    {
        ...
        {
            await ProcessarTipoDespesaEmergencial(despesa, tipoPagamento, quantidadeTransacao, statusPagamento, valorTransacao);
        }

        public async Task ProcessarTipoDespesaEmergencial(Despesa despesa, TipoPagamento tipoPagamento, int quantidadeTransacao, bool statusPagamento, decimal valorTransacao)
        {
            try
            {
