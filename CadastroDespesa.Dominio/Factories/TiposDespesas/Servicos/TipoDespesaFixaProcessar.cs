...
namespace CadastroDespesa.Dominio.Factories.TiposDespesas.Servicos
{
    public class TipoDespesaFixaProcessar : ITipoDespesaFixaProcessar
    {
        ...
        {
            await ProcessarTipoDespesaFixa(despesa,  quantidadeTransacao,  statusPagamento,  valorTransacao);
        }

        public async Task ProcessarTipoDespesaFixa(Despesa despesa, int quantidadeTransacao, bool statusPagamento, decimal valorTransacao)
        {
            try
            {
