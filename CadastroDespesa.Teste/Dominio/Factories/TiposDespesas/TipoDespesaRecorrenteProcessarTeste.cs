...
{
    public class TipoDespesaRecorrenteProcessarTeste
    {
        private readonly Mock<ITransacaoDespesaRepositorio> transacaoDespesaMock;
        private readonly TipoDespesaRecorrenteProcessar tipoDespesaRecorrenteProcessar;
        public TipoDespesaRecorrenteProcessarTeste()
        {
            transacaoDespesaMock = new Mock<ITransacaoDespesaRepositorio>();
            tipoDespesaRecorrenteProcessar = new(transacaoDespesaMock.Object);
        }

        [Fact]
        public async Task Quando_Tipo_Despesa_For_Recorrente_Espero_Processar_Tipo_Despesa_Recorrente()
        {
            int idTipoDespesa = 1;
            ...
            await tipoDespesaRecorrenteProcessar.Processar(despesa, tipoPagamento, quantidadeTransacao, statusPagamento, valor); ;

            await tipoDespesaRecorrenteProcessar
                  .ProcessarTipoDespesaRecorrente(despesa, tipoPagamento, quantidadeTransacao, statusPagamento, valor);
        }
