...
{
    public class TipoDespesaVariavelProcessarTeste
    {
        private readonly Mock<ITransacaoDespesaRepositorio> transacaoDespesaMock;
        private readonly TipoDespesaVariavelProcessar tipoDespesaVariavelProcessar;
        public TipoDespesaVariavelProcessarTeste()
        {
            transacaoDespesaMock = new Mock<ITransacaoDespesaRepositorio>();
            tipoDespesaVariavelProcessar = new(transacaoDespesaMock.Object);
        }

        [Fact]
        public async Task Quando_Tipo_Despesa_For_Variavel_Espero_Processar_Tipo_Despesa_Variavel()
        {
            int idTipoDespesa = 1;
            ...
            await tipoDespesaVariavelProcessar.Processar(despesa, tipoPagamento, quantidadeTransacao, statusPagamento, valor); ;

            await tipoDespesaVariavelProcessar
                  .ProcessarTipoDespesaVariavel(despesa, tipoPagamento, quantidadeTransacao, statusPagamento, valor);
        }
